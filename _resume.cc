...
C++/C, Python, JavaScript, bash/shell script, HTML/CSS, MATLAB, Visual Basic, C#, Objective-C.    

Framework/Tool/Libs: 
Flask, Dash, jQuery, Express, Nodejs, React, Docker, MongoDB, Redis, MySQL, make.
...
Development: Python based application.
Build: Pyinstaller.
CICD: Jenkins.
Cloud: AWS S3, Google drive.

3. Linux image/ISO development:
...
* Specialize in C/C++ case handling. 
* Provide tecnical solutions, include POC (Proof of concept), snippet developing/dubugging, performance/architecture, networking debugging.
...
FORU-TEK: 2016-2017
Software Engineer
* Research and develop a routing algorithm to solve TSP (Traveling salesman problem) for Mobile applications, uses C# and C++.
...
Two papers image processing and machine learning papers accepted by IEEE:
...
Chung Yuan Christian University: Taoyuan, Taiwan, 2010-2014
Bachelor of Science and Engineering: Major in Electrical Engineering

Publications and Projects
1. First Author, “Efficient Reflection Removal Algorithm for Single Image by
Pixel Compensation and Detail Reconstruction” (2018 IEEE Conf. on DSP
        (Digital Signal Processing)).
2. Third Author, “Color Channel-Based Smoke Removal Algorithm Using
Machine Learning for Static Images” (2018 IEEE Conf. on ICIP (International
            Conference on Image Processing)).
3. APP development, Algorithm design, “Trip Planner”, with FORU-TEK.
